...
def toggle_dark_mode():
    global dark_mode_active, bg_color, fg_color
...
# Set the icon
window.iconbitmap("C:\\Users\Davide\Pictures\\4470502.ico")

# Greeting popup [! BETA]
messagebox.showwarning("Welcome to Beta", "Welcome to Grade Calculator, This is a beta version, it might be bugged")

# Thanks for testing popup
messagebox.showinfo("This is last popup", "Thanks for testing!")
...
# Button Dark Mode on the right (Insomma in basso a destra)
dark_mode_button.place(relx=1.0, rely=1.0, anchor='se', x=-10, y=-10)
